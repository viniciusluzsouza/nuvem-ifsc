-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc/Untitled/P1.vhd
...
-- -------------------------------------------------------------
-- Out_P1_1                      ce_out        0.000125
-- Out_P1_2                      (no clock)    inf
-- -------------------------------------------------------------
-- 
-- -------------------------------------------------------------
...
ENTITY P1 IS
  PORT( clk                               :   IN    std_logic;
        ...
        Out_P1_1                          :   OUT   std_logic_vector(31 DOWNTO 0);  -- sfix32_En27
        Out_P1_2                          :   OUT   std_logic_vector(31 DOWNTO 0)  -- sfix32_En27
        );
END P1;
...
ARCHITECTURE rtl OF P1 IS
  ...
  SIGNAL C1_out1                          : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL TmpGroundAtOut_P1_2Inport1_out1  : signed(31 DOWNTO 0);  -- sfix32_En27
...
-- FULL WAVE LOOKUP TABLE
  ...
  TmpGroundAtOut_P1_2Inport1_out1 <= to_signed(0, 32);
